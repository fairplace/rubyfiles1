class Media
 ...
 #all child clases inherits parents clases
class Book < Media
...
my_magazine=magazine.new
my_magazine.set_publish_schedule= monday, tuesday
my_magazine.set_title="make_it_happen"
puts my_magazine.get_title
puts my_magazine.publish_schedule


#inspects the above code

puts my_book.inspect
puts my_magazine.inspect
